...
class LinesChart extends StatelessWidget {
  const LinesChart({super.key, required this.isShowingMainData});

  final bool isShowingMainData;

  @override
  Widget build(BuildContext context) {
    return LineChart(isShowingMainData ? sampleData1 : sampleData2);
  }
  ...
  LineChartBarData get lineChartBarData1_2 => LineChartBarData(
        ...
        belowBarData: BarAreaData(
          show: false,
          color: const Color(0xFF00BF63).withOpacity(0),
        ),
        spots: const [
          FlSpot(1, 1),
          FlSpot(3, 2.8),
